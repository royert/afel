			...
			if ($ac != 0) {
				...
				while ($row = mysqli_fetch_assoc($res)) {
					...
					<tr>
						...
						<td><a href="./modificar_entrenador_ficha.php?id_user=<?php echo $row['id_usuario']; ?>" name="seleccionar"><i class="fa-solid fa-pen-to-square"></i></a></td>
