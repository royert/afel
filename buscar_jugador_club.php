...
<body>
	...
	<main class="main">
		...
		<br>
		<br>
		<div class="table-responsive table-borderless table-responsive-sm table-responsive-md table-responsive-lg table-responsive-xl table_jug">

		<table class="table table-striped table-bordered table-borderless table-hover table_id table-sm" action="modificar_jugador.php" method="POST">
				...
				<tbody>
					...
					while ($row = mysqli_fetch_assoc($res)) {
						...
						<tr>
							...
							<td><a href="./modificar_jugador_club.php?id_user=<?php echo $row['id_usuario']; ?>" name="seleccionar"><i class="fa-solid fa-pen-to-square"></i></a></td>
							<td><a href="./controlador/rnj1_jug.php?id_user=<?php echo $row['id_usuario']; ?>" name="seleccionar" target="__BLANK"><i class="fa-solid fa-pen-to-square"></i></a></td>
							<td><a href="./controlador/carnet_por_jug.php?id_user=<?php echo $row['id_usuario']; ?>" name="seleccionar" target="__BLANK"><i class="fa-solid fa-pen-to-square"></i></a></td>
						</tr>
