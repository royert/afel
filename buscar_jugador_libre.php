		...
		<div class="div-form row g-5 form">
			<div class="div-form row g-5 form">
				<form method="POST" class="div-form row g-5 form">
					...
					<div class="col-sm-2 form-check">
						<button id="buscar" class="btn btn-outline-success form-check" name="buscar" tpe="buttom" >Buscar</button>
	...
	<table class="table table-striped table-bordered table-borderless table-hover table_id table-sm">
		...
		if (isset($_POST['buscar'])) {
			...
			if ($club != 0) {
				...
				`listado`
				WHERE
				`id_club` = $club AND `id_status_verificacion` = '$v_status' AND `id_status_sistema` = '$s_status'";
				...
				while ($row = mysqli_fetch_assoc($res)) {
					...
					<tr>
						...
						<td><a href="./fichar_jugador_libre.php?id_user=<?php echo $row['id_usuario']; ?>" name="seleccionar"><i class="fa-solid fa-pen-to-square"></i></a></td>
				...
				`listado`
				WHERE
				`id_categoria` = $cat AND `id_status_verificacion` = '$v_status' AND `id_status_sistema` = '$s_status'";
				...
				while ($row = mysqli_fetch_assoc($res)) {
					...
					<tr>
						...
						<td><a href="./fichar_jugador_ficha.php?id_user=<?php echo $row['id_usuario']; ?>" name="seleccionar"><i class="fa-solid fa-pen-to-square"></i></a></td>
				...
				`listado`
				WHERE 
				`id_status_verificacion` = '$v_status' AND `id_status_sistema` = '$s_status'";
