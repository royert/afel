...
switch ($id_t_us) {
	case '6':
	header("location: ./buscar_entrenador_club.php");
	break;
	case '4':
				...
				<tbody>
					...
					while ($row = mysqli_fetch_assoc($res)) {
						...
						<tr>
							...
							<td><a href="./modificar_entrenador_club.php?id_usuario=<?php echo $row['id_usuario']; ?>" name="seleccionar"><i class="fa-solid fa-pen-to-square"></i></a></td>
						</tr>
