...
switch ($id_t_us) {
	case '6':
	header("location: ./agregar_jugador_club.php");
	break;
	case '4':
				...
				<form class="needs-validation" enctype="multipart/form-data" method="POST" action="./controlador/agregar_jugador.php" novalidate>
					<div class="row g-5">
						...
						<div class="row g-3">
							<div class="col-sm-6">
								<label for="inputAddress">Primer Nombre</label>
								<input type="text" class="form-control" id="inputAddress" onkeyup="this.value=Text(this.value)" placeholder="Primer Nombre" name="nombre_usuario_representante" required="">
								<div class="invalid-feedback">
									Ingrese el primer nombre
								</div>
							</div>
							...
							<div class="col-sm-6">
								<label for="inputAddress">Segundo Nombre</label>
								<input type="text" class="form-control" id="inputAddress" onkeyup="this.value=Text(this.value)" placeholder="Segundo Nombre" name="segundo_nombre_usuario_representante" required="">
								<div class="invalid-feedback">
									Ingrese el segundo nombre
								</div>
							</div>
							<div class="col-sm-6">
								<label for="inputAddress">Primer Apellido</label>
								<input type="text" class="form-control" id="inputAddress" onkeyup="this.value=Text(this.value)" placeholder="Primer Apellido" name="apellido_usuario_representante" required="">
								<div class="invalid-feedback">
									Ingrese el primer apellido
								</div>
							</div>
							...
							<div class="col-sm-6">
								<label for="inputAddress">Segundo Apellido</label>
								<input type="text" class="form-control" id="inputAddress" onkeyup="this.value=Text(this.value)" placeholder="Segundo Apellido" name="segundo_apellido_usuario_representante" required="">
								<div class="invalid-feedback">
									Ingrese el segundo apellido
								</div>
							</div>
							<div class="col-sm-6">
								<label for="inputAddress">Cedula</label>
								<input type="text" class="form-control" id="inputAddress" onkeyup="this.value=Numeros(this.value)" placeholder="Cedula" name="ci_usuario_representante" required="">
								<div class="invalid-feedback">
									Ingrese la cedula
								</div>
							</div>
							...
							<div class="col-sm-6">
								...
								<input type="text" class="form-control" id="inputAddress" onkeyup="this.value=Numeros(this.value)" placeholder="Telefono" name="tlf_representante" required="">
								<div class="invalid-feedback">
									Ingrese el telefono
								</div>
							</div>
							<div class="col-md-6">
								...
								<select class="form-select select-categoria" id="country" name="select-status-repre" required="">
									<option value="">SELECCIONE</option>
									<?php
