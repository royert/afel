	...
	<main class="main">
		...
		<div class="row g-5 form">
			<div class="col-md-7 col-lg-8 form-h">
				...
				<form class="needs-validation" enctype="multipart/form-data" method="POST" action="./controlador/agregar_jugador.php" novalidate>
					<div class="row g-5">
						<div class="col-sm-6">
							<label for="inputAddress">Primer Nombre</label>
							<input type="text" class="form-control" id="inputAddress" placeholder="Primer Nombre" name="nombre_usuario" required="">
						...
						<div class="col-sm-6">
							...
							<input type="text" class="form-control" id="inputAddress" placeholder="Segundo Nombre" name="segundo_nombre_usuario" required="">
							<div class="invalid-feedback">
						...
						<div class="col-sm-6">
							...
							<input type="text" class="form-control" id="inputAddress" placeholder="Primer Apellido" name="apellido_usuario" required="">
							<div class="invalid-feedback">
						...
						<div class="col-sm-6">
							...
							<input type="text" class="form-control" id="inputAddress" placeholder="Segundo Apellido" name="segundo_apellido_usuario" required="">
							<div class="invalid-feedback">
						...
						<div class="col-sm-6">
							...
							<input type="text" class="form-control" id="inputAddress" placeholder="Cedula" name="ci_usuario" required="">
							<div class="invalid-feedback">
								Ingrese la cedula
							</div>
						</div>
						...
						<div class="row g-3">
							<div class="col-sm-6">
								<label for="inputAddress">Primer Nombre</label>
								<input type="text" class="form-control" id="inputAddress" placeholder="Primer Nombre" name="nombre_usuario_representante" required="">
								<div class="invalid-feedback">
									Ingrese el primer nombre
								</div>
							</div>
							...
							<div class="col-sm-6">
								<label for="inputAddress">Segundo Nombre</label>
								<input type="text" class="form-control" id="inputAddress" placeholder="Segundo Nombre" name="segundo_nombre_usuario_representante" required="">
								<div class="invalid-feedback">
									Ingrese el segundo nombre
								</div>
							</div>
							<div class="col-sm-6">
								<label for="inputAddress">Primer Apellido</label>
								<input type="text" class="form-control" id="inputAddress" placeholder="Primer Apellido" name="apellido_usuario_representante" required="">
								<div class="invalid-feedback">
									Ingrese el primer apellido
								</div>
							</div>
							...
							<div class="col-sm-6">
								<label for="inputAddress">Segundo Apellido</label>
								<input type="text" class="form-control" id="inputAddress" placeholder="Segundo Apellido" name="segundo_apellido_usuario_representante" required="">
								<div class="invalid-feedback">
									Ingrese el segundo apellido
								</div>
							</div>
							<div class="col-sm-6">
								<label for="inputAddress">Cedula</label>
								<input type="text" class="form-control" id="inputAddress" placeholder="Cedula" name="ci_usuario_representante" required="">
								<div class="invalid-feedback">
									Ingrese la cedula
								</div>
							</div>
							<div class="col-sm-6">
								<label for="inputAddress2">Fecha de Nacimiento</label>
								<input type="date" class="form-control" id="inputAddress2" name="fecha_nac_representante" required="">
								<div class="invalid-feedback">
									Ingrese una fecha de nacimiento
								</div>
							</div>
							<div class="col-sm-6">
								...
								<input type="text" class="form-control" id="inputAddress" placeholder="Telefono" name="tlf_representante" required="">
								<div class="invalid-feedback">
									Ingrese el telefono
								</div>
							</div>
							...
							<div class="col-12">
								...
								<input type="text" class="form-control" id="address" placeholder="Direccion" name="direccion_representante" required>
								<div class="invalid-feedback">
