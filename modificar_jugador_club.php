                            ...
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <li class="mb-1">
                                    ...
                                    <div class="collapse" id="jugadores-collapse">
                                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ">
                                            <li><a href="agregar_jugador_club.php" class="offcanvas-title">Agregar
                                                    Jugador</a></li>
                                            <li><a href="buscar_jugador_club.php" class="offcanvas-title">Buscar
                                                    Jugador</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="mb-1">
                                    ...
                                    <div class="collapse" id="entrenadores-collapse">
                                        <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                            <li><a href="agregar_entrenador_club.php" class="offcanvas-title">Agregar
                                                    Entrenador</a></li>
                                            <li><a href="buscar_entrenador_club.php" class="offcanvas-title">Buscar
                                                    Entrenador</a></li>
                                        </ul>
                                    </div>
                                </li>
        ...
        <div class="row g-5 form">
            <div class="col-md-7 col-lg-8 form-h">
                ...
                <form class="needs-validation" enctype="multipart/form-data" method="POST"
                    action="./controlador/modificar_jugador.php" novalidate>
                    <div class="row g-5">
                        <div class="form-group">

                            <input type="hidden" class="form-control" id="inputAddress" placeholder="1234 Main St"
                                name="id_us" value="<?php echo $row['id_usuario']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="inputAddress">Primer Nombre</label>
                            <input type="text" class="form-control" onkeyup="this.value=Text(this.value)"
                                id="inputAddress" placeholder="Primer Nombre" name="nombre_usuario"
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" onkeyup="this.value=Text(this.value)"
                                id="inputAddress" placeholder="Segundo Nombre" name="segundo_nombre_usuario"
                                value="<?php echo $row['segundoN']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="inputAddress">Primer Apellido</label>
                            <input type="text" class="form-control" onkeyup="this.value=Text(this.value)"
                                id="inputAddress" placeholder="Primer Apellido" name="apellido_usuario"
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" onkeyup="this.value=Text(this.value)"
                                id="inputAddress" placeholder="Segundo Apellido" name="segundo_apellido_usuario"
                                value="<?php echo $row['segundoA']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="inputAddress">Cedula</label>
                            <input type="text" class="form-control" onkeyup="this.value=Numeros(this.value)"
                                id="inputAddress" placeholder="Cedula" name="ci_usuario"
                                value="<?php echo $row['ci']; ?>">
                        </div>
                        <div class="col-sm-6">
                            <label for="inputAddress2">Fecha de Nacimiento</label>
                            <input type="date" class="form-control" id="inputAddress2" placeholder="Fecha de Nacimiento"
                                name="fecha_nac" value="<?php echo $row['fecha_nac_us']; ?>">
                        </div>
