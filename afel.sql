...
(5, 'roger', 'eduardo', 'romero', 'escalona', 'rere12', 'affa2df08b04cf9fda34284198b2f76e', 1);
...
CREATE TABLE `carnets` (
  ...
  `nombre_carnet` varchar(300) NOT NULL,
  `carnet_front` varchar(300) NOT NULL,
...
(1, 'carnet-afel', 'img/foto-carnet/carnet.jpeg', 'img/foto-carnet/carnet-reverso.jpg', 'image/jpeg', 'image/jpg');
...
CREATE TABLE `cat_to_mod_atl` (
  `id_cat_to_mod_atl` int(11) NOT NULL,
  `id_categoria` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
...
CREATE TABLE `representante` (
  ...
  `segundoN_representante` varchar(60) NOT NULL,
  `apellido_representante` varchar(60) NOT NULL,
  `segundoA_representante` varchar(60) NOT NULL,
  `ci_representante` int(8) NOT NULL,
  `fecha_nac` date NOT NULL,
  `fecha_registro` datetime NOT NULL,
  `tlf` int(11) NOT NULL,
  `direccion` varchar(300) NOT NULL,
  `ci_imagen_representante` varchar(300) NOT NULL,
...
(1, 'PRESIDENTE', 1),
(2, 'SECRETARIO GENERAL', 1),
(3, 'CONSULTOR JURIDICO', 1),
(4, 'OFICIAL FICHAJE', 1),
(5, 'OFICIAL COMPETICIONES', 1),
(6, 'CLUB', 1),
(7, 'JUGADOR', 1),
(8, 'ARBITRO', 1),
(9, 'ENTRENADOR', 1),
...
ALTER TABLE `carnet`
  ...
  ADD KEY `id_usuario` (`id_usuario`,`id_status_sistema`),
  ADD KEY `id_status_sistema` (`id_status_sistema`);
...
ALTER TABLE `cat_to_mod_atl`
  ...
  ADD KEY `id_categoria` (`id_categoria`,`id_usuario`,`id_modalidad`),
...
ALTER TABLE `equipo_tec`
  ...
  ADD KEY `id_club` (`id_club`,`id_usuario`,`id_t_usuario`,`id_status_sistema`),
  ADD KEY `id_usuario` (`id_usuario`),
  ADD KEY `id_t_usuario` (`id_t_usuario`),
  ADD KEY `id_status_sistema` (`id_status_sistema`);
...
ALTER TABLE `estadio`
  ...
  ADD KEY `id_status_sistema` (`id_status_sistema`,`id_modalidad`),
  ADD KEY `id_modalidad` (`id_modalidad`);
...
ALTER TABLE `fichaje`
  ...
  ADD KEY `id_club` (`id_club`,`id_usuario`,`id_status_sistema`,`id_status_verificacion`),
  ADD KEY `id_status_sistema` (`id_status_sistema`),
  ADD KEY `id_status_verificacion` (`id_status_verificacion`),
  ADD KEY `id_usuario` (`id_usuario`);
...
ALTER TABLE `representante_to_usuario`
  ...
  ADD KEY `id_representante` (`id_representante`,`id_usuario`),
  ADD KEY `id_usuario` (`id_usuario`);
...
ALTER TABLE `usuario`
  ...
  ADD KEY `id_t_usuario` (`id_t_usuario`,`id_status_sistema`,`id_club`,`id_categoria`),
  ADD KEY `id_status_sistema` (`id_status_sistema`),
  ADD KEY `id_club` (`id_club`),
  ADD KEY `id_categoria` (`id_categoria`),
  ADD KEY `id_t_usuario_2` (`id_t_usuario`),
  ADD KEY `id_status_verificacion` (`id_status_verificacion`),
...
ALTER TABLE `carnet`
  ...
  ADD CONSTRAINT `carnet_ibfk_2` FOREIGN KEY (`id_adm`) REFERENCES `admin` (`id_adm`),
...
ALTER TABLE `cat_to_mod_atl`
  ...
  ADD CONSTRAINT `cat_to_mod_atl_ibfk_2` FOREIGN KEY (`id_categoria`) REFERENCES `categoria` (`id_categoria`),
...
ALTER TABLE `equipo_tec`
  ...
  ADD CONSTRAINT `equipo_tec_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`),
  ADD CONSTRAINT `equipo_tec_ibfk_3` FOREIGN KEY (`id_t_usuario`) REFERENCES `tipo_usuario` (`id_t_usuario`),
...
ALTER TABLE `fichaje`
  ...
  ADD CONSTRAINT `fichaje_ibfk_2` FOREIGN KEY (`id_status_verificacion`) REFERENCES `status_verificacion` (`id_status_verificacion`),
  ADD CONSTRAINT `fichaje_ibfk_3` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`),
...
ALTER TABLE `historico_fichaje`
  ...
  ADD CONSTRAINT `historico_fichaje_ibfk_2` FOREIGN KEY (`id_club`) REFERENCES `club` (`id_club`),
  ADD CONSTRAINT `historico_fichaje_ibfk_3` FOREIGN KEY (`id_status_verificacion`) REFERENCES `status_verificacion` (`id_status_verificacion`),
