...
$status_af = $_POST['select-status-club'];
$status_ligas = $_POST['select-ligas'];
...
if (isset($img_logo) && $img_logo != "" && isset($img_acta) && $img_acta != "") 
	{
		$sql = "UPDATE `club` SET `nombre_club`='$name',`fecha_fund`='$fecha_fund',`id_status_sistema`='$status', `tipo_acta`='$tipo_acta',`img_acta`='$url_acta',`tipo_logo`='$tipo_logo',`img_logo`='$url_logo', `id_status_club` = '$status_af', `id_ligas` = '$status_ligas' WHERE `id_club`= '$id_club' ";
		...
		if ($res) {
			...
			$sql = "UPDATE `club` SET `nombre_club`='$name',`fecha_fund`='$fecha_fund',`id_status_sistema`='$status', `tipo_logo`='$tipo_logo',`img_logo`='$url_logo', `id_status_club` = '$status_af', `id_ligas` = '$status_ligas' WHERE `id_club`= '$id_club' ";
		$res = mysqli_query($conn, $sql);
		if ($res) {
			move_uploaded_file($img_logo, '../img/logo/'.$nombre_logo);
