    ...
    <main class="main">
		...
		if (isset($_POST['buscar'])) {
			...
			if ($ac != 0) {
				...
				`tipo_usuario`
				WHERE
				`usuario`.`nombre_usuario` LIKE '%' 
				AND `usuario`.`segundoN` LIKE '%'
				AND `usuario`.`apellido` LIKE '%'
				AND `usuario`.`segundoA` LIKE '%' 
				AND `usuario`.`ci` LIKE '%' 
				AND `usuario`.`fecha_nac_us` LIKE '%' 
				AND `usuario`.`fecha_registro_us` LIKE '%' 
				AND (`usuario`.`id_club` LIKE '%' AND `club`.`id_club` = `usuario`.`id_club`) 
				AND (`usuario`.`id_t_usuario`LIKE '%$tipo_jug%' AND `tipo_usuario`.`id_t_usuario` = `usuario`.`id_t_usuario`)
				AND(`usuario`.`id_categoria` LIKE '%' AND `categoria`.`id_categoria` = `usuario`.`id_categoria`) 
				AND(`usuario`.`id_status_sistema` LIKE '%$ac%' AND `status_sistema`.`id_status_sistema` = `usuario`.`id_status_sistema`) 
				AND(`usuario`.`id_status_verificacion` LIKE '%' AND `status_verificacion`.`id_status_verificacion` = `usuario`.`id_status_verificacion`) order by nombre_usuario asc";
				...
				while ($row = mysqli_fetch_assoc($res)) {
                    ...
                    <tr>
                        ...
                        <td><a href="./modificar_jugador_ficha.php?id_user=<?php echo $row['id_usuario']; ?>"
				...
				AND `usuario`.`fecha_nac_us` LIKE '%' 
				AND `usuario`.`fecha_registro_us` LIKE '%' 
				AND (`usuario`.`id_club` LIKE '%$club%' AND `club`.`id_club` = `usuario`.`id_club`) 
				AND (`usuario`.`id_t_usuario`LIKE '%$tipo_jug%' AND `tipo_usuario`.`id_t_usuario` = `usuario`.`id_t_usuario`)
				AND(`usuario`.`id_categoria` LIKE '%' AND `categoria`.`id_categoria` = `usuario`.`id_categoria`) 
				AND(`usuario`.`id_status_sistema` LIKE '%' AND `status_sistema`.`id_status_sistema` = `usuario`.`id_status_sistema`) 
				AND(`usuario`.`id_status_verificacion` LIKE '%' AND `status_verificacion`.`id_status_verificacion` = `usuario`.`id_status_verificacion`) order by nombre_usuario asc";
				...
				AND (`usuario`.`id_club` LIKE '%' AND `club`.`id_club` = `usuario`.`id_club`) 
				AND (`usuario`.`id_t_usuario`LIKE '%$tipo_jug%' AND `tipo_usuario`.`id_t_usuario` = `usuario`.`id_t_usuario`)
				AND(`usuario`.`id_categoria` LIKE '%$cat%' AND `categoria`.`id_categoria` = `usuario`.`id_categoria`) 
				AND(`usuario`.`id_status_sistema` LIKE '%' AND `status_sistema`.`id_status_sistema` = `usuario`.`id_status_sistema`) 
				AND(`usuario`.`id_status_verificacion` LIKE '%' AND `status_verificacion`.`id_status_verificacion` = `usuario`.`id_status_verificacion`) order by nombre_usuario asc";
				...
				AND(`usuario`.`id_categoria` LIKE '%' AND `categoria`.`id_categoria` = `usuario`.`id_categoria`) 
				AND(`usuario`.`id_status_sistema` LIKE '%' AND `status_sistema`.`id_status_sistema` = `usuario`.`id_status_sistema`) 
				AND(`usuario`.`id_status_verificacion` LIKE '%$ver%' AND `status_verificacion`.`id_status_verificacion` = `usuario`.`id_status_verificacion`) order by nombre_usuario asc";
