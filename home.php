							...
							<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
								...
								<li class="mb-1">
									...
									<div class="collapse" id="jugadores-collapse">
										<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ">
											<li><a href="agregar_jugador.php" class="offcanvas-title">Agregar Jugador</a></li>
											<li><a href="buscar_jugador.php" class="offcanvas-title">Buscar Jugador</a></li>
										</ul>
									</div>
								</li>
								<li class="mb-1">
									...
									<div class="collapse" id="entrenadores-collapse">
										<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
											<li><a href="agregar_entrenador.php" class="offcanvas-title">Agregar Entrenador</a></li>
											<li><a href="buscar_entrenador.php" class="offcanvas-title">Buscar Entrenador</a></li>
										</ul>
									</div>
								</li>
